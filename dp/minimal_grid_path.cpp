...
// ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
// HOW IS THIS DP AND NOT GRAPHS???????? ITS GRAPH GREEDY BRO
signed main()
{
	init();
	int n; cin >> n;
	...
	while(true)
	{
		...
		while(!q.empty())
		{
			...
			if (min(v[i][j+1], v[i+1][j]) < best)
			{
				front = {};
				best = min(v[i][j+1], v[i+1][j]);
			}
			if (!vis[i][j+1] && v[i][j+1] == best)
			{
				front.push({i, j+1});
				vis[i][j+1] = 1;
			}
			if (!vis[i+1][j] && v[i+1][j] == best)
			{
				front.push({i+1, j});
				vis[i+1][j] = 2;
			}
